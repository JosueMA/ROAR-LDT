...
response.data <- read.csv('LDT_alldata_wide_sorted.csv')
...
ggsave('CorrelationMatrix.png',c1,width=5.5, height=4.5)

# g = arrangeGrob(p1,c1,nrow=1)
# ggsave('Figure1_PercentCorrect_CorrMat.pdf',g,width=11, height=4.5)
